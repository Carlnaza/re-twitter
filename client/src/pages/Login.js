...
export default function Login() {
    ...
    const [yearConfirm, setYearConfirm] = useState(true)
    ...
    const register = () => {
        ...
        if (modalSteps === 1) {
            ...
            if (registerState.name === '') { setNameConfirm(false) }
            if (registerState.phone === '') { setPhoneConfirm(false) }
            if (year - registerState.year < 13) { setYearConfirm(false) }
                                ...
                                </ModalHeader>
                                {
                                    modalSteps === 1 ?
                                        <Container>
                                            <input
                                                type="text"
                                                className={`form-control form-control-lg mt-4 ${nameConfirm ? null : "is-invalid"}`}
                                                placeholder="Name"
                                                name="name"
                                            ...
                                            />
                                            {
                                                nameConfirm ? null : <p className="text-danger">Please enter a valid Name.</p>
                                            }
                                            <input
                                                type="phone"
                                                className={`form-control form-control-lg mt-4 ${phoneConfirm ? null : "is-invalid"}`}
                                                placeholder="Phone"
                                                maxLength="10"
                                                name="phone"
                                            ...
                                            />
                                            {
                                                phoneConfirm ? null : <p className="text-danger">Please enter a valid Phone Number.</p>
                                            }
                                            ...
                                            {
                                                yearConfirm ? null : <p className="text-danger mt-2 mb-0">You must be 13 years or older to register on this site.</p>
                                            }
